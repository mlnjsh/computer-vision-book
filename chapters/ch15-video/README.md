...
- Notebook: [`../../notebooks/ch15_video.ipynb`](../../notebooks/)
- Case study: [`../../case-studies/ch15/`](../../case-studies/)
- Figures: [`../../figures/ch15/`](../../figures/)

## Datasets (Kaggle)
- `matteomedioli/youtube8m` — `kaggle datasets download -d matteomedioli/youtube8m`
...
- [ ] All figures generated and saved to `figures/ch15/`
