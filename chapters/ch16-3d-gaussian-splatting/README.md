...
- Notebook: [`../../notebooks/ch16_3d-gaussian-splatting.ipynb`](../../notebooks/)
- Case study: [`../../case-studies/ch16/`](../../case-studies/)
- Figures: [`../../figures/ch16/`](../../figures/)

## Datasets (Kaggle)
- `soumikrakshit/kitti-dataset` — `kaggle datasets download -d soumikrakshit/kitti-dataset`
...
- [ ] All figures generated and saved to `figures/ch16/`
