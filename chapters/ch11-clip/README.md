...
- Notebook: [`../../notebooks/ch11_clip.ipynb`](../../notebooks/)
- Case study: [`../../case-studies/ch11/`](../../case-studies/)
- Figures: [`../../figures/ch11/`](../../figures/)

## Datasets (Kaggle)
- `adityajn105/flickr8k` — `kaggle datasets download -d adityajn105/flickr8k`
- `hsankesara/flickr-image-dataset` — `kaggle datasets download -d hsankesara/flickr-image-dataset`
...
- [ ] All figures generated and saved to `figures/ch11/`
