...
- Notebook: [`../../notebooks/ch19_edge-deployment.ipynb`](../../notebooks/)
- Case study: [`../../case-studies/ch19/`](../../case-studies/)
- Figures: [`../../figures/ch19/`](../../figures/)

## Datasets (Kaggle)
- (no Kaggle dataset for this chapter — uses local/synthetic data)
...
- [ ] All figures generated and saved to `figures/ch19/`
