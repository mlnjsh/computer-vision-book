...
- Notebook: [`../../notebooks/ch12_diffusion.ipynb`](../../notebooks/)
- Case study: [`../../case-studies/ch12/`](../../case-studies/)
- Figures: [`../../figures/ch12/`](../../figures/)

## Datasets (Kaggle)
- `splcher/animefacedataset` — `kaggle datasets download -d splcher/animefacedataset`
- `jessicali9530/celeba-dataset` — `kaggle datasets download -d jessicali9530/celeba-dataset`
...
- [ ] All figures generated and saved to `figures/ch12/`
