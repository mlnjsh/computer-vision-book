...
- Notebook: [`../../notebooks/ch13_vlm.ipynb`](../../notebooks/)
- Case study: [`../../case-studies/ch13/`](../../case-studies/)
- Figures: [`../../figures/ch13/`](../../figures/)

## Datasets (Kaggle)
- `dansbecker/imagenet-test` — `kaggle datasets download -d dansbecker/imagenet-test`
...
- [ ] All figures generated and saved to `figures/ch13/`
