...
- Notebook: [`../../notebooks/ch03_classical-features.ipynb`](../../notebooks/)
- Case study: [`../../case-studies/ch03/`](../../case-studies/)
- Figures: [`../../figures/ch03/`](../../figures/)

## Datasets (Kaggle)
- `balraj98/stanford-background-dataset` — `kaggle datasets download -d balraj98/stanford-background-dataset`
...
- [ ] All figures generated and saved to `figures/ch03/`
